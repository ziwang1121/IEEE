...
def get_default_config():
    ...
    cfg.data.workers = 1 # number of data loading workers
    ...
    cfg.loss.triplet = CN()
    cfg.loss.triplet_margin = 0.3 # distance margin
    cfg.loss.ieee_margin = 3 # distance margin
    cfg.loss.weight_c = 1. # weight to balance center loss
    cfg.loss.weight_t = 1. # weight to balance hard triplet loss
    cfg.loss.weight_m = 1. # weight to balance margin loss
    cfg.loss.weight_x = 1. # weight to balance cross entropy loss
