...
class OSnet3modal(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        super(OSnet3modal, self).__init__()
        self.modal_number = 3
        self.loss = loss
        ...
        self.backbone = nn.ModuleList(
            [
                osnet_x0_5(num_classes, pretrained=True)
...
def osnet3modal(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = OSnet3modal(
