...
def eval_cuhk03(distmat, q_pids, g_pids, q_camids, g_camids, q_timeids, g_timeids, max_rank):
...
def eval_regdb(distmat, q_pids, g_pids, q_timeids, g_timeids, max_rank = 20):
    num_q, num_g = distmat.shape
    if num_g < max_rank:
        max_rank = num_g
...
def evaluate_py(
    distmat, q_pids, g_pids, q_camids, g_camids, q_timeids, g_timeids, max_rank, use_metric_cuhk03
):
    if use_metric_cuhk03:
        return eval_cuhk03(
            distmat, q_pids, g_pids, q_camids, g_camids, q_timeids, g_timeids, max_rank
        )
    else:
