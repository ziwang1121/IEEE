...
from torchreid.data.datasets.image import UAV
from torchreid.data.datasets.image import RGBNT201

from .image import (
    GRID, PRID, CUHK01, CUHK02, CUHK03, MSMT17, CUHKSYSU, VIPeR, SenseReID,
    Market1501, DukeMTMCreID, University1652, iLIDS, UAV, RGBNT201, market_to_RGBNT201, AllDay
)
