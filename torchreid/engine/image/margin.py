...
from torchreid.losses import TripletLoss, CrossEntropyLoss, multiModalMarginLoss, multiModalMarginLossNew
...
class Image3MEngine(Engine):
    ...
    #     outputs_R, outputs_N, features_RGB, features_NI = self.model(imgs)
